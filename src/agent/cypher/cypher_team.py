...
class CypherTeam(Team):
    ...
    instructions = dedent(
        ...
        - "Must" Follow and Print the **Thought-Act-Observation** chain-of-thought traces:
            ...
            2. **Act**: Use tools, Or Assign subtasks to team members, Or Generate a Cypher statement.
    ...
    def __init__(
        ...
        storage: Optional[Storage] = YamlStorage(dir_path=database_dir, mode="team"),
        ...
        if tools is None:
            ...
            tools = [
                ...
                neo4j_tools.execute_cypher_statement,
            ]
        super().__init__(
            members,
            mode,
